...
class TeamSidebar:
    ...
    def init_ui(self, parent, draft_callback):
        self.current_drafter_label = ttk.Label(parent, text=self.draft_manager.current_drafter_text(),
                                               font=("Helvetica", 16))
        ...
        self.team_combobox = ttk.Combobox(parent, values=self.draft_manager.teams_in_draft_order,
                                          font=("Helvetica", 16))
    ...
    def update_team_display(self, event=None):
        ...
        team_players = self.draft_manager.get_players_from_team(selected_team)
